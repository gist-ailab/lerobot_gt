...
if __name__ == '__main__':
    ...
    for episode in episodes:
        ...
        for color_ts, color_data in color_frames_data1:                
            ...
            # print(synced_franka_state['data'].keys())
        ...
        for i in range(5, len(synced_frames)-2):
                ...
                # print(i, current_sync_frame['franka_state']['data'].keys())
                cur_gripper_state = current_sync_frame['franka_state']['data']['gripper_state']
                ...
                n_gripper_state = next_sync_frame['franka_state']['data']['gripper_state']
                ...
                next_gripper_open = 1 if n_gripper_state > 0.05 else 0
                gripper_open = 1 if cur_gripper_state > 0.05 else 0
                # delta = False
                ...
                action = np.concatenate([delta_pose, [next_gripper_open]])
